...
namespace zzzz
{
    internal class SpellDrawer
    {
        ...
        private void Game_OnGameLoad()
        {
            ...
            Evade.drawMenu = new Menu("Draw", "線圈設置");
            Evade.drawMenu.Add(new MenuBool("DrawSkillShots", "啟用顯示"));
            Evade.drawMenu.Add(new MenuBool("ShowStatus", "躲避狀態顯示"));
            Evade.drawMenu.Add(new MenuBool("DrawSpellPos", "繪製法術位置"));
            Evade.drawMenu.Add(new MenuBool("DrawEvadePosition", "繪製逃避位置"));

            var dangerMenu = new Menu("DangerLevelDrawings", "危險等級線粗");
            dangerMenu.Add(new MenuSlider("LowWidth", "低危險", 3, 1, 15));
            //lowDangerMenu.Add(new MenuComponent("LowColor", "低危险顏色").SetValue(new Circle(true, Color.FromArgb(60, 255, 255, 255))));

            dangerMenu.Add(new MenuSlider("NormalWidth", "中危險", 3, 1, 15));
            //normalDangerMenu.Add(new MenuComponent("NormalColor", "中危险顏色").SetValue(new Circle(true, Color.FromArgb(140, 255, 255, 255))));

            dangerMenu.Add(new MenuSlider("HighWidth", "高危險", 3, 1, 15));
            //highDangerMenu.Add(new MenuComponent("HighColor", "高危险顏色").SetValue(new Circle(true, Color.FromArgb(255, 255, 255, 255))));

            dangerMenu.Add(new MenuSlider("ExtremeWidth", "極高危險", 4, 1, 15));
            //extremeDangerMenu.Add(new MenuComponent("ExtremeColor", "極高危险顏色").SetValue(new Circle(true, Color.FromArgb(255, 255, 255, 255))));
